...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2021 at 08:56 PM
...
(1, 'Hot deals as this Asian', 'lorem-ipsum-is', '/storage/photos/1/Banner/banner-01.jpg', '<h2><span style=\"font-weight: bold; color: rgb(99, 99, 99);\">Up to 10%</span></h2><h2><span style=\"font-weight: bold; color: rgb(99, 99, 99);\"><br></span></h2>', 'active', '2020-08-14 01:47:38', '2021-04-21 13:15:17'),
...
INSERT INTO `products` (`id`, `title`, `slug`, `summary`, `description`, `photo`, `stock`, `size`, `ram`, `condition`, `status`, `price`, `discount`, `is_featured`, `cat_id`, `child_cat_id`, `brand_id`, `created_at`, `updated_at`) VALUES
(11, 'Oneplus 9 Pro 5G', 'oneplus-9-pro-5g', '<p>oneplus 9 pro</p>', '<p>5G</p>', '/storage/photos/1/Products/OP9-pro-1.jpg,/storage/photos/1/Products/OP9-pro-2.jpg', 2, '256', '12', 'superb', 'active', 64999.00, 2.00, 1, 13, NULL, 9, '2021-04-21 08:31:22', '2021-04-21 08:31:22');
...
(1, 'We are Grest, the leading marketplace dedicated to refurbished devices. Our mission is to bring the refurbished goods as a main stream of new products.', 'We are Grest, the leading marketplace dedicated to refurbished devices. Our mission is to bring the refurbished goods as a main stream of new products.', '/storage/photos/1/main_logo.png', '/storage/photos/1/blog3.jpg', '7 & 8, Hemant Complex, Opposite Mayon Hospital, South City-1 Market, South City-1, Gurgaon - 122001', '(+91) 8810 501 502', 'info@grest.in', NULL, '2021-04-21 12:25:43');
